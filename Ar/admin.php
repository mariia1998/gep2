...
<input type="text" placeholder="...بحث" id="search" class="form-control form-control-sm" name="" value="">
...
<button type="button" class="btn btn-primary btn-block" name="button" id="renouvler" onclick="">تجديد</button>
